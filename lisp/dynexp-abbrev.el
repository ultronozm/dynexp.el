...
<+TAB+>}<+END+>" dynexp)
   ...
   ;; ("sl2" "<+START+>\\SL_2<+END+>" dynexp-delete-leading-space-dynexp)
   ("sl2" "\\SL_2" nil)
   ("sl3" "\\SL_3" nil)
   ("sln" "\\SL_n" nil)
   ("gl2" "\\GL_2" nil)
   ...
   ("pgln" "\\PGL_n" nil)
   ("tra" "\\trace" nil)
   ("slu" "<+START+>\\SL_{<+++>}<++><+END+>" dynexp-delete-leading-space-dynexp)
   ("pglu" "<+START+>\\PGL_{<+++>}<++><+END+>" dynexp-delete-leading-space-dynexp)
   ("glu" "<+START+>\\GL_{<+++>}<++><+END+>" dynexp-delete-leading-space-dynexp)
